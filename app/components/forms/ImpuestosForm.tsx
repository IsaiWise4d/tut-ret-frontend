...
export default function ImpuestosForm() {
  ...
  const eliminarFechaPactada = (id: number) => {
    if (fechasPactadas.length > 1) {
      setFechasPactadas(fechasPactadas.filter((f) => f.id !== id));
    }
  };
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-32 rounded-lg border border-zinc-300 bg-white px-4 py-2.5 text-center text-sm text-zinc-900 transition-all focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white"
                />
      ...
      <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <div className="space-y-3">
          ...
          {fechasPactadas.map((fecha, index) => (
            <div key={fecha.id} className="flex items-center gap-4">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-blue-50 to-purple-50 text-sm font-semibold text-blue-600 dark:from-blue-900/30 dark:to-purple-900/30 dark:text-blue-400">
                {index + 1}
              </div>
              ...
              {fechasPactadas.length > 1 && (
                <button
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-lg border-2 border-red-500 text-red-500 transition-all hover:bg-red-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:focus:ring-offset-zinc-900"

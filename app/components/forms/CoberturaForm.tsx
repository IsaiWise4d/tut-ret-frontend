...
export default function CoberturaForm() {
  ...
  const incrementarAnos = () => setAnos((prev) => prev + 1);
  const decrementarAnos = () => setAnos((prev) => (prev > 0 ? prev - 1 : 0));
  ...
  <div className="rounded-lg border border-zinc-200 bg-white p-6 animate-fade-up will-change-transform">
        <label className="mb-2 block text-sm font-semibold text-zinc-900">Cobertura</label>
        <input
          type="text"
          ...
          className="mb-4 w-full rounded-lg border border-zinc-300 bg-zinc-50 px-4 py-2 text-sm font-medium uppercase text-zinc-600 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
        <textarea
          ...
          className="w-full rounded-lg border border-zinc-300 bg-white px-4 py-3 text-sm text-zinc-900 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>

      {/* Clausulado Aplicable */}
  <div className="rounded-lg border border-zinc-200 bg-white p-6 animate-fade-up will-change-transform">
        <label className="mb-2 block text-sm font-semibold text-zinc-900">Clausulado Aplicable</label>
        <input
          type="text"
  ...
  <div className="rounded-lg border border-zinc-200 bg-white p-6 animate-fade-up will-change-transform">
        <h3 className="mb-4 text-sm font-semibold text-zinc-900">Base de la cobertura</h3>

        {/* Primera fila: Años y Radio buttons */}
        <div className="mb-4 grid grid-cols-1 gap-4 lg:grid-cols-12">
          {/* Años */}
          <div className="lg:col-span-2">
            <label className="mb-2 block text-sm font-medium text-zinc-700">Años</label>
            <div className="flex items-center gap-1">
              <input
                ...
                min="0"
                className="w-16 rounded-lg border border-zinc-300 bg-white px-2 py-1.5 text-sm text-zinc-900 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <div className="flex flex-col">
                <button
                  type="button"
                  onClick={incrementarAnos}
                  className="rounded-t border border-zinc-300 bg-white px-1.5 py-0.5 text-xs leading-none hover:bg-zinc-50"
                >
                  ▲
                </button>
                <button
                  ...
                  className="rounded-b border border-t-0 border-zinc-300 bg-white px-1.5 py-0.5 text-xs leading-none hover:bg-zinc-50"
                >
                  ▼
                </button>
              </div>
          ...
          <div className="flex items-end gap-6 lg:col-span-7">
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="claims-made" className="text-sm font-medium text-zinc-900">Claims Made</label>
            </div>
            <div className="flex items-center gap-2">
              <input
                type="radio"
                ...
                className="h-4 w-4 border-zinc-300 text-blue-600 focus:ring-2 focus:ring-blue-500"
              />
              <label htmlFor="ocurrencia" className="text-sm font-medium text-zinc-900">Ocurrencia</label>
            </div>
            <div className="flex items-center gap-2">
              <input
                type="radio"
                ...
                className="h-4 w-4 border-zinc-300 text-blue-600 focus:ring-2 focus:ring-blue-500"
              />
              <label htmlFor="hibrida" className="text-sm font-medium text-zinc-900">Híbrida</label>
            </div>
          </div>

          {/* Notas label */}
          <div className="lg:col-span-3">
            <label className="mb-2 block text-sm font-medium text-zinc-700">Notas</label>
          </div>
        </div>
        ...
        <div className="mb-4 grid grid-cols-1 gap-4 lg:grid-cols-12">
          ...
          <div className="lg:col-span-2">
            <label className="mb-2 block text-sm font-medium text-zinc-700">Base Cobertura</label>
          </div>
        ...
        <div className="mb-4 grid grid-cols-1 gap-4 lg:grid-cols-12">
          <div className="lg:col-span-2">
            <label className="mb-2 block text-sm font-semibold text-zinc-700">Actos Previos</label>
          </div>
        </div>
        <div className="mb-4">
          <textarea
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          <div>
            <label className="mb-2 block text-sm font-semibold text-zinc-700">Retroactividad Claims</label>
            <textarea
          ...
          <div>
            <label className="mb-2 block text-sm font-semibold text-zinc-700">Retroactividad Ocurrencia</label>
            <textarea
